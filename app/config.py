...
class Settings(BaseSettings):
    ...
    apollo_confidence_threshold: float = Field(default=0.60, description="Minimum Apollo confidence to treat a forecast as actionable")
    apollo_mape_threshold: float = Field(default=2.5, description="Maximum Apollo MAPE to treat a forecast as actionable")
